...
export const KIND_CLASSES = {
  primary: 'bg-amber-500 text-white hover:bg-amber-300  border-transparent',
  ...
  white: 'text-amber-600 border-gray-300 hover:bg-gray-50',
  transparent:
    'text-indigo-700 bg-none border-none hover:bg-indigo-200 shadow-none',
...
export const Button = ({
  ...
  return (
    <button
      ...
      type={type}
      disabled={disabled}
      className={`inline-flex items-center justify-center gap-2 border h-max ${fullWidthClass} ${MEASURE_CLASSES[size]} ${roundedClass} font-medium rounded-md shadow-sm ${KIND_CLASSES[kind]} disabled:bg-amber-100`}
      {...props}
    >
